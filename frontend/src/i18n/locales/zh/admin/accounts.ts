export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketPausedCredential: '账号凭据不可用，该模型已暂停',
        codexTurnTicketPausedIncomplete: '探测响应未完成，该模型已暂停',
        codexTurnTicketPausedInvalid: '未返回有效门票，该模型已暂停',
        codexTurnTicketRetryNow: '立即重试',
        codexTurnTicketRetrying: '正在探测 292',
        codexTurnTicketRetryStarted: '已开始重试 292 门票',
        codexTurnTicketRetryFailed: '启动 292 门票重试失败',
        codexTurnTicketAutoRetryIn: '{time} 后自动重试',
        codexTurnTicketManualCooldown: '{time} 后可再次手动重试',
