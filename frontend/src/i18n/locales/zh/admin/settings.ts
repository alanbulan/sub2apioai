export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketProxyPoolDesc: '所有已启用节点会并发探测；并行出口数可增加同一动态代理每轮使用的独立会话。业务请求不会经过此代理池。',
        ...
        codexTicketProxyParallelism: '并行出口数（1-10）',
        codexTicketProxyRotateOnFailure: '失败后调用已配置的换 IP 接口',
        codexTicketProxyMoveUp: '上移',
        codexTicketProxyMoveDown: '下移',
        codexTicketProxyRemove: '删除代理',
        codexTicketRetryInterval: '持续重试间隔（秒）',
