    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketHarvestProxyDesc:
          '仅在门票功能开启时用于打票，日常业务仍走账号自己的住宅代理。在代理 URL 的会话位置填 __SESSION__，系统会为每个账号/模型生成独立的 12 位粘性会话，探测失败时在退避限频内自动轮换。不含占位符时保持固定代理行为。保存后生效，无需重启；留空表示不改已保存的值。',
        ...
        codexTicketProxyPool: '292 打票代理池',
        codexTicketProxyPoolDesc: '优先使用数值较小的优先级；同一优先级按权重分配探测。业务请求不会经过此代理池。',
        codexTicketProxyAdd: '添加代理',
        codexTicketProxyEmpty: '尚未配置打票代理',
        codexTicketProxyEnabled: '启用代理',
        codexTicketProxyName: '代理名称',
        codexTicketProxyURL: '代理 URL',
        codexTicketProxyPriority: '优先级（0-100）',
        codexTicketProxyWeight: '权重（1-100）',
        codexTicketProxyMoveUp: '上移',
        codexTicketProxyMoveDown: '下移',
        codexTicketProxyRemove: '删除代理',
        codexTicketRetryCount: '快速重试次数',
