export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketProxyPool: "292 harvest proxy pool",
        codexTicketProxyPoolDesc: "All enabled nodes probe concurrently. Parallel exits add independent sessions from the same dynamic proxy per round. Production requests do not use this pool.",
        codexTicketProxyAdd: "Add proxy",
        codexTicketProxyEmpty: "No harvest proxies configured",
        codexTicketProxyEnabled: "Enable proxy",
        codexTicketProxyName: "Proxy name",
        codexTicketProxyURL: "Proxy URL",
        codexTicketProxyPriority: "Priority (0-100)",
        codexTicketProxyWeight: "Weight (1-100)",
        codexTicketProxyParallelism: "Parallel exits (1-10)",
        codexTicketProxyRotateOnFailure: "Use configured IP rotation endpoint after failure",
        codexTicketProxyMoveUp: "Move up",
        codexTicketProxyMoveDown: "Move down",
        codexTicketProxyRemove: "Remove proxy",
        codexTicketRetryInterval: "Continuous retry interval (seconds)",
