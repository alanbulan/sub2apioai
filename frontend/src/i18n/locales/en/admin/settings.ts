export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketProxyPoolDesc: "Lower priority values are used first; proxies at the same priority share probes by weight. Production requests do not use this pool.",
