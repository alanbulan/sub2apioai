export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketPausedCredential: 'Account credentials unavailable; model paused',
        codexTurnTicketPausedIncomplete: 'Probe did not complete; model paused',
        codexTurnTicketPausedInvalid: 'No valid ticket returned; model paused',
